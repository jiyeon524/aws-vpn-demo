...
sed -i ‘s/CONN_TUNNEL1_ONPREM_INSIDE_IP/$CONN_TUNNEL1_ONPREM_INSIDE_IP/g’ ipsec-vti.sh
sed -i ‘s/CONN_TUNNEL1_AWS_INSIDE_IP/$CONN_TUNNEL1_AWS_INSIDE_IP/g’ ipsec-vti.sh
sed -i ‘s/CONN_TUNNEL2_ONPREM_INSIDE_IP/$CONN_TUNNEL2_ONPREM_INSIDE_IP/g’ ipsec-vti.sh
sed -i ‘s/CONN_TUNNEL2_AWS_INSIDE_IP/$CONN_TUNNEL2_AWS_INSIDE_IP/g’ ipsec-vti.sh
