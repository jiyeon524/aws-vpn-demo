export AWS_VPN_TUNNEL_IP1="<AWS_VPN_OUTSIDE_TUNNELIP1>"
export AWS_VPN_TUNNEL_IP2="<AWS_VPN_OUTSIDE_TUNNELIP2>"
export CGW_IP="<On-prem CGW IP>"
export CGW_CIDR="172.32.0.0/16"
